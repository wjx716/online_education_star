  ...
  <div class="in-wrap">
    ...
    <header id="header">
      <section class="container">
        <h1 id="logo">
          <a href="../" title="星辰教育">
            <img src="~/assets/img/logo.png" width="100%" alt="星辰教育" />
          </a>
        </h1>
        <div class="h-r-nsl">
          <ul class="nav">
      ...
      <section class="container">
        <div class>
          ...
          <ul class="of flink-list">
            <li>
              <a href="http://localhost:3000" title="星辰教育" target="_blank"
                >星辰教育</a
              >
            </li>
          </ul>
          ...
          <section class="fl col-7">
            <section class="mr20">
              <section class="b-f-link">
                ...
                <span>服务热线：028-0000-0000</span>
                <span>Email：XXX@XXX.com</span>
              </section>
              <section class="b-f-link mt10">
                <span>©2021课程版权均归 星辰教育 所有 京ICP备XXXXXXX号</span>
              </section>
            </section>
          </section>
